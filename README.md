ru.rtz.service parser writen on Java. 
This is the easiest way to work with ru.rtz.service files if you want to create your own maritime navigational application
or just work with ru.rtz.service files Build-in features:
* Waypoints and Legs creation.
* Calculation of Great Circle and Rhumbline distances and courses 
* ETA calculation 
* .ru.rtz.service file validator 
